...
export function IPCBackendChart() {
  ...
  const data = [
    { name: 'DirectChannel\n(same thread)', p50: 14, p99: 14, category: 'intra' },
    { name: 'SpscIntra\n(1:1 thread)', p50: 82, p99: 85, category: 'intra' },
    { name: 'SpmcIntra\n(1:N thread)', p50: 95, p99: 119, category: 'intra' },
    { name: 'MpscIntra\n(N:1 thread)', p50: 178, p99: 317, category: 'intra' },
    { name: 'MpmcIntra\n(N:N thread)', p50: 182, p99: 354, category: 'intra' },
    { name: 'SpscShm\n(cross-process)', p50: 162, p99: 191, category: 'shm' },
    { name: 'PodShm\n(broadcast)', p50: 165, p99: 246, category: 'shm' },
  ];
