...
- Remove `order` &rarr; defaults to 0 (no ordering preference)
...
BestEffort class at `rate=30` and `order=0` (the defaults). Ticks in the main loop at the scheduler's global rate. This is the simplest valid configuration.
