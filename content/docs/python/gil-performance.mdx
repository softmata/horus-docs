...
| `img.to_numpy()` | ~3μs | SHM view (zero-copy) |
...
### Use Zero-Copy Views for Images
...
# FAST: ~3μs (zero-copy view into the SHM pool)
frame = img.to_numpy()
```
...
- [NumPy & Zero-Copy](/python/numpy-zerocopy) — Zero-copy NumPy views and pool-backed images
