...
For network or file I/O operations that would block a real-time thread. Runs on a tokio runtime. In Python, this class is **automatic** — just use `async def` for your tick function.
