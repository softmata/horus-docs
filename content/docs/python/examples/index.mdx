...
logger = horus.Node(name="logger", subs={"cmd_vel": {"type": horus.CmdVel}}, tick=logger_tick, rate=10)
...
if received is not None:
    ...
    tensor = torch.from_numpy(received.to_numpy())  # PyTorch (zero-copy for CPU tensors)
