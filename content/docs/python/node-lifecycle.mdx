...
Publish a message. Non-blocking. If the ring buffer is full, a point-to-point (1:1) topic drops the new message (keeping the queued ones, in order); a broadcast topic overwrites the oldest.
