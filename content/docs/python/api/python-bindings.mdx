...
machine. Earlier versions of this page documented UDP, Unix-socket and router forms;
...
| `topic.is_network_topic` | Property: `True` when the endpoint string contains an `@`. Cosmetic only — no topic uses a network transport (see above) |
