...
> **Note:** Most users should use `Image`, `PointCloud`, or `DepthImage` instead. `TensorHandle` is for advanced custom tensor workflows where the built-in types do not fit your needs.

Low-level tensor handle for advanced zero-copy scenarios.
...
> **Note:** Most users should use `Image`, `PointCloud`, or `DepthImage` instead. `TensorPool` is for advanced custom tensor workflows where the built-in types do not fit your needs.
