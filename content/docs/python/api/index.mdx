...
- `SchedulerConfig` — Configuration presets (safety-critical, high-performance, etc.)
- `HFrame` / `Transform` — Coordinate frame management
...
| `SchedulerConfig` | Scheduler configuration with presets |
...
| Class | Description |
|-------|-------------|
| `HFrame` | Coordinate frame tree with transform lookups |
| `Transform` | 3D transformation (translation + quaternion rotation) |
| `HFrameConfig` | HFrame configuration with size presets |
