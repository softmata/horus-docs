...
The Python message types are **binary-compatible with Rust** via shared memory. The Rust
side reaches them through `horus::prelude`:

| Python Class | Rust Type | Defining Crate |
|--------------|-----------|----------------|
| `CmdVel` | `horus::prelude::CmdVel` | `horus_robotics` |
| `Pose2D` | `horus::prelude::Pose2D` | `horus_types` |
| `Imu` | `horus::prelude::Imu` | `horus_robotics::messages::sensor` |
| `Odometry` | `horus::prelude::Odometry` | `horus_robotics::messages::sensor` |
| `LaserScan` | `horus::prelude::LaserScan` | `horus_robotics::messages::sensor` |
| `Twist` | `horus::prelude::Twist` | `horus_types` |
| `Transform` | `horus_tf::Transform` | `horus_tf` (separate crate) |
| `Image` | `horus::prelude::Image` | `horus_core::memory` |
| `PointCloud` | `horus::prelude::PointCloud` | `horus_core::memory` |
| `DepthImage` | `horus::prelude::DepthImage` | `horus_core::memory` |
| `NavGoal` | `horus::prelude::NavGoal` | `horus_robotics::messages::navigation` |
...
det = Detection(
    class_name="person",  # Class label (up to 32 chars)
...
print(path.total_length)     # read-only property, meters
...
**Available now** (via `from horus import <Type>`):
