...
5. **Pin toolchain versions** — `horus doctor --fix` installs missing toolchains/system deps and pins their versions to `[toolchain]` and `[[system]]`
...
- [Package Management](/package-management/package-management) — Dependency management
- [Configuration](/package-management/configuration) — Registry configuration
