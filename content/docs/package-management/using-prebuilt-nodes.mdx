...
**The HORUS Philosophy:** Don't reinvent the wheel. Use comprehensive, battle-tested nodes from the registry and the HORUS standard prelude, then configure them to work together.
...
**For cargo projects** (not using `horus run`):
