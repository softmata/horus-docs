...
**Usage:**
```bash
horus pkg update [PACKAGE] [OPTIONS]
```
...
horus pkg update pid-controller

# Update global packages
horus pkg update -g

# Preview updates without applying
horus pkg update --dry-run
```
