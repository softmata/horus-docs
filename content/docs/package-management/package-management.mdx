...
To publish packages to the HORUS registry, see the **[Registry Author Guide](https://registry.horusrobotics.dev/guide)** on the registry website. It covers:
...
- **[Registry Guide](https://registry.horusrobotics.dev/guide)** — Publishing packages to the registry
