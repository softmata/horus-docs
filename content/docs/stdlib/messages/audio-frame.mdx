...
|-------|------|-------------|
| `samples` | `[f32; 4800]` | Audio sample buffer (Rust), `list[float]` (Python -- only valid samples) |
| `num_samples` | `u32` | Number of valid samples in buffer |
| `sample_rate` | `u32` | Sample rate in Hz (8000, 16000, 44100, 48000) |
| `channels` | `u8` | Channel count (1=mono, 2=stereo, N=mic array) |
| `encoding` | `u8` | Audio encoding (0=F32, 1=I16) |
| `timestamp_ns` | `u64` | Capture timestamp in nanoseconds |
