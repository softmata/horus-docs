...
Use `horus hardware` for hardware discovery from the command line:
...
horus hardware scan --json

# Show platform information
horus hardware platform
...
- [I/O Messages](/rust/api/io-messages) - Communication protocol messages
