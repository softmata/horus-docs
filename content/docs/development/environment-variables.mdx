...
| `HORUS_LOG_BUFFER_SIZE` | `5000` | Entries held in the in-memory ring the monitor reads |
...
| `HORUS_DOCS_DIR` | unset | Path to a `horus-docs` checkout, for the documentation contract tests |
...
`HORUS_TEST_BUILD_EXAMPLES`, `HORUS_INSTALL_BRANCH`.
