...
- `HorusError` - The same enum under its long name, for exhaustive pattern matching
...
Variants that have no named constructor are built from their structured sub-error:
