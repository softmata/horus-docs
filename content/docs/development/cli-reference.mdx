...
reporting what the system claims to support. Toolchains are graded per language, so a
missing C++ compiler does not drag down an otherwise healthy Rust and Python setup.
