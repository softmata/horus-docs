...
> **Note**: `priority` and `rate_hz` are both inert. Each is exported to the child process
> — as `HORUS_NODE_PRIORITY` and `HORUS_NODE_RATE_HZ` — and nothing in the workspace reads
