...
**What it does**: Sets up shell integration so native tools (`cargo`, `pip`, `cmake`) run through HORUS.

**Why it's useful**: Lets you keep using the native toolchain commands you already know without wiring up paths by hand.
