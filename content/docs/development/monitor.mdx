...
1. Open monitor
2. Check health badge  [OK] All good
...
**Security note:** Password-based authentication is available. On first run, you can set a password to protect the monitor. See [Monitor Security](/development/monitor-security) for details.
