...
- Completed [Tutorial 1](/docs/tutorials/01-sensor-node-cpp) and [Tutorial 2](/docs/tutorials/02-motor-controller-cpp)
...
- [Cross-Language Interop](/docs/tutorials/cross-language-interop) — mix C++, Rust, Python in one system
- [Guide: Hardware Integration](/docs/cpp/hardware) — connect real sensors
- [Guide: Real-Time C++](/docs/cpp/realtime) — SCHED_FIFO, CPU pinning
