---
title: "Tutorial 2: Motor Controller"
description: "Create a motor controller node that subscribes to velocity commands and publishes joint position"
order: 20
---

# Tutorial 2: Motor Controller

<Callout type="info">Looking for the **Python version**? See [Tutorial 2: Motor Controller (Python)](/tutorials/02-motor-controller-python).</Callout>
