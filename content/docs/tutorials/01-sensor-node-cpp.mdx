...
- [Sensor Messages](/cpp/api/sensor-messages) — the standard IMU message type
- [C++ Topic API](/cpp/api/topic) — full Publisher/Subscriber reference
- [IMU Reader Recipe (C++)](/recipes/imu-reader) — a production complementary-filter pipeline
