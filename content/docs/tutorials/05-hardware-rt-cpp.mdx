...
on_shutdown():       close device, release resources
```
...
public:
    ...
    void on_shutdown() override {
        ...
        horus::log::info("motor", "Serial port closed");
    }
...
int main() {
    ...
    sched.add(motor)
        ...
        .watchdog(1_s)               // per-node watchdog
        .build();
...
- [Tutorial 10: Write a Reusable Driver](/tutorials/10-write-a-driver-cpp) — package this driver with configuration and diagnostics
- [Real-Time Control](/tutorials/realtime-control-cpp) — a 1 kHz loop with jitter measurement and a failsafe
