...
<Callout type="info">Prefer another language? The same tutorial exists for [C++](/tutorials/03-full-robot-cpp).</Callout>
...
```bash
sudo setcap 'cap_sys_nice=ep' ./target/release/full_robot
```
