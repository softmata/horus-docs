...
[Quick Start](/getting-started/quick-start) teaches and what `horus new`
...
flowchart LR
    ...
    CTRL -->|"cmd_vel"| MOTOR
`}
  caption="A 10 Hz Python node and a 1 kHz Rust node share topics, not a process — each ticks at its own rate"
/>
