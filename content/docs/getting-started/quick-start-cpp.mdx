...
> If you prefer Rust, see the [Rust Quick Start](/getting-started/quick-start). For Python, see the [Python Quick Start](/getting-started/quick-start-python).
...
- [Getting Started with C++](/getting-started/cpp) — full API overview with all message types
- [C++ API Reference](/reference/cpp-api) — complete class/method reference
- [Migrating from ROS2 C++](/tutorials/migrating-from-ros2-cpp) — side-by-side comparison
- [Multi-Language Guide](/concepts/multi-language) — mix C++, Rust, and Python in one system
- [Tutorials](/tutorials) — LiDAR robot, motor controllers, sensor fusion
