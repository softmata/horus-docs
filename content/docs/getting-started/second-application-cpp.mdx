...
You've built a [Quick Start](/getting-started/quick-start-cpp) app. Now build a real robot: a mobile base with lidar, IMU, motor control, coordinate transforms, runtime parameters, and a service.
...
- [C++ API Reference](/reference/cpp-api) — full class/method documentation
- [Multi-Language Guide](/concepts/multi-language) — combine C++, Rust, and Python
- [Execution Classes](/concepts/execution-classes) — RT, Compute, Event, AsyncIo
- [Safety Monitor](/advanced/safety-monitor) — watchdog, safe state, BlackBox
