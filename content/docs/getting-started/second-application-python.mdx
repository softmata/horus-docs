...
1. **[Python API Reference](/python/api)** -- Full `horus.Node`, `horus.Scheduler`, and `horus.Topic` docs
2. **[Testing](/development/testing)** -- Learn how to unit test your nodes with `tick_once()`
3. **[Message Types](/concepts/message-types)** -- Use typed messages (`horus.CmdVel`, `horus.Imu`) instead of primitives
4. **[Using Pre-Built Nodes](/package-management/using-prebuilt-nodes)** -- Use library nodes instead of writing from scratch
...
- [Recipes](/recipes) -- Production-ready patterns to copy
