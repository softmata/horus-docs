...
```bash
git clone https://gitlab.com/softmata/horus.git
cd horus
./install.sh
```
...
curl -fsSL https://gitlab.com/softmata/horus/-/raw/release/install.sh -o install.sh
git clone https://gitlab.com/softmata/horus.git --branch release --depth 1
