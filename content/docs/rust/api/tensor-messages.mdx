...
let depth = DepthImage::new(640, 480, TensorDtype::U16);
...
- [Python Memory Types](/python/api/memory-types) — Image, PointCloud, DepthImage, TensorHandle with NumPy/PyTorch/JAX interop
