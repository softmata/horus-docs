...
- **RT auto-detection**: Setting `.budget()`, `.deadline()`, or `.rate()` automatically marks the node as real-time (`ExecutionClass::Rt`)
...
- [Node API](/concepts/core-concepts-node) -- Node trait and lifecycle
- [Scheduler](/concepts/scheduler) -- Scheduler configuration and execution classes
