...
struct SensorNode {
    dio_pub: Topic<DigitalIO>,
    aio_pub: Topic<AnalogIO>,
    i2c_pub: Topic<I2cMessage>,
}
...
- [Hardware API](/rust/api/hardware) - Hardware abstraction API
