...
HORUS provides message types for ML model inference, training, and LLM integration in robotics applications. These are serde-based types in `horus_library::messages::ml` — all available via `use horus::prelude::*`.
