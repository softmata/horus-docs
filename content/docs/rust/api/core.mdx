...
```rust
scheduler.tick_rate(1000_u64.hz());   // u64 impl
scheduler.tick_rate(100.hz());        // bare integer literal infers i32
scheduler.tick_rate(2.5.hz());        // f64 impl — fractional rates are fine
```
