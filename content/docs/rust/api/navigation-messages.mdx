...
| `occupancy(grid_x, grid_y)` | Get occupancy value at grid coordinates (`Option<i8>`) |
...
| `254` | Unused at the default `lethal_cost` |
| `255` | Unknown cell (above lethal — treat as blocked) |
