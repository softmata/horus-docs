...
**Convenience re-exports** (available via `use horus_robotics::prelude::*`): `NavGoal`, `NavPath`, `PathPlan`, `OccupancyGrid`, `CostMap`.

**Non-re-exported types** (require direct import): `GoalStatus`, `GoalResult`, `Waypoint`, `VelocityObstacle`, `VelocityObstacles` — import from `horus_robotics::messages::navigation::*`.
...
> **Note:** `GoalStatus` is not re-exported in the prelude. Import directly: `use horus_robotics::messages::navigation::GoalStatus;`

```rust
// simplified
use horus_robotics::messages::navigation::GoalStatus;
...
> **Note:** `GoalResult` is not re-exported in the prelude. Import directly: `use horus_robotics::messages::navigation::GoalResult;`

```rust
// simplified
use horus_robotics::messages::navigation::{GoalResult, GoalStatus};
...
> **Note:** `Waypoint` is not re-exported in the prelude. Import directly: `use horus_robotics::messages::navigation::Waypoint;`

```rust
// simplified
use horus::prelude::*;
use horus_robotics::prelude::*;
use horus_robotics::messages::navigation::Waypoint;
...
> **Note:** `VelocityObstacle` is not re-exported in the prelude. Import directly: `use horus_robotics::messages::navigation::VelocityObstacle;`

```rust
// simplified
use horus_robotics::messages::navigation::VelocityObstacle;
...
> **Note:** `VelocityObstacles` is not re-exported in the prelude. Import directly: `use horus_robotics::messages::navigation::VelocityObstacles;`

```rust
// simplified
use horus_robotics::messages::navigation::{VelocityObstacles, VelocityObstacle};
...
use horus::prelude::*;
use horus_robotics::prelude::*;
use horus_robotics::messages::navigation::{GoalResult, GoalStatus, Waypoint};
