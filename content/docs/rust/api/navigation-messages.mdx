...
**Available via** `use horus_robotics::prelude::*`: `NavGoal`, `NavPath`, `PathPlan`, `OccupancyGrid`, `CostMap`, `GoalStatus`, `GoalResult`, `Waypoint`, `VelocityObstacle`, `VelocityObstacles` — all robotics navigation types are re-exported through the prelude glob.
...
> **Note:** `GoalStatus` is available via `use horus_robotics::prelude::*;`.
...
> **Note:** `GoalResult` is available via `use horus_robotics::prelude::*;`.
...
> **Note:** `Waypoint` is available via `use horus_robotics::prelude::*;`.
...
> **Note:** `VelocityObstacle` is available via `use horus_robotics::prelude::*;`.
...
> **Note:** `VelocityObstacles` is available via `use horus_robotics::prelude::*;`.
