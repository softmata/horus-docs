...
All algorithms are available through `horus::prelude::*`:

```rust
use horus::prelude::*; // Provides all algorithms: AStar, EKF, PID, PurePursuit, RRT, SensorFusion, DifferentialDrive, OccupancyGrid, etc.
```
...
```rust
use horus::prelude::*; // Provides {AStar, PurePursuit}
...
```rust
use horus::prelude::*; // Provides {EKF, SensorFusion}
...
```rust
use horus::prelude::*; // Provides {PID, MotorCommand, Odometry}

struct MotorController {
    pid: PID,
    cmd_pub: Topic<MotorCommand>,
