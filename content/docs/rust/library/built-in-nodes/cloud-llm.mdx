...
struct VoiceCommandNode {
    prompt_pub: Topic<LLMRequest>,
    response_sub: Topic<LLMResponse>,
    cmd_pub: Topic<RobotCommand>,
}
...
struct TaskPlannerNode {
    llm_pub: Topic<LLMRequest>,
    llm_sub: Topic<LLMResponse>,
}
...
let stream_sub = Topic::String>::new("robot.responses.stream")?;
