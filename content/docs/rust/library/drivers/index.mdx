...
```rust
use horus::prelude::*; // Provides {ImuDriver, SimulationImuDriver, Mpu6050Driver, MotorDriver, SimulationMotorDriver, I2cDriver, SimulationI2cDriver}
...
```rust
use horus::prelude::*; // Provides {ImuDriver, SimulationImuDriver, DriverStatus}
...
```rust
use horus::prelude::*; // Provides {MotorDriver, SimulationMotorDriver}
...
```rust
use horus::prelude::*; // Provides {JoystickDriver, SimulationJoystickDriver, ButtonMapping}
...
```rust
use horus::prelude::*; // Provides {KeyboardDriver, SimulationKeyboardDriver, KEY_W, KEY_A, KEY_S, KEY_D, KEY_SPACE}
...
```rust
use horus::prelude::*; // Provides {I2cDriver, SimulationI2cDriver}
...
```rust
use horus::prelude::*; // Provides {DriversConfig, SingleDriverConfig}
...
```rust
use horus::prelude::*; // Provides {create_imu_driver, create_lidar_driver, create_camera_driver, create_motor_driver, create_drivers_from_config, CreatedDrivers, list_available_backends, SingleDriverConfig}
...
For simple one-off drivers, you can create structs directly. For **distributable drivers** that support auto-detection, dynamic loading, and publishing to the HORUS registry, see the [Driver Plugin Development](/rust/library/drivers/plugin-development) guide.

### Implement a Custom Sensor Driver

```rust
use horus::prelude::*; // Provides {DriverStatus, Imu}
...
```rust
use horus::prelude::*; // Provides DriverStatus
...
```rust
use horus::prelude::*; // Includes keyboard keycodes
...
```rust
use horus::prelude::*; // Provides ButtonMapping
...
| Guide | Description |
|-------|-------------|
| [Simulation to Hardware Workflow](/rust/library/drivers/workflow) | Complete development lifecycle from simulation to production |
| [Driver Testing Guide](/rust/library/drivers/testing) | Testing strategies for drivers with simulation and hardware |
| [Driver Troubleshooting](/rust/library/drivers/troubleshooting) | Diagnose and fix common driver issues |

### Architecture & Patterns

| Guide | Description |
|-------|-------------|
| [Multi-Driver Scenarios](/rust/library/drivers/multi-driver) | Differential drive, sensor fusion, redundancy patterns |
| [DriverLoader Configuration](/rust/library/drivers/driver-loader) | Static, dynamic, and hybrid plugin loading modes |
| [Driver Error Handling](/rust/library/drivers/error-handling) | Error types, recovery strategies, and resilient patterns |

### Plugin Development

| Guide | Description |
|-------|-------------|
| [Driver Plugin Development](/rust/library/drivers/plugin-development) | Create distributable driver plugins with auto-detection |
...
- [Driver Plugin Development](/rust/library/drivers/plugin-development) - Create distributable driver plugins with auto-detection
- [Simulation to Hardware Workflow](/rust/library/drivers/workflow) - Development lifecycle guide
- [Driver Error Handling](/rust/library/drivers/error-handling) - Error patterns and recovery
...
- [DriverLoader Configuration](/rust/library/drivers/driver-loader) - Plugin loading modes
