...
flowchart LR
    DEV["1. DEVELOP<br/>Simulation Driver"]
    TEST["2. TEST<br/>Simulation Tests"]
    VAL["3. VALIDATE<br/>Hardware Tests"]
    DEPLOY["4. DEPLOY<br/>Production"]
    DEV --> TEST
    TEST --> VAL
    VAL --> DEPLOY
    DEPLOY -.->|"Iterate & Fix"| DEV
`}
  caption="Development lifecycle: simulation-first development"
/>
