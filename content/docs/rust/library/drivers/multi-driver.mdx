...
flowchart TB
    subgraph Sensors["Sensors"]
        IMU["IMU<br/>Driver"]
        ENC_L["Encoder Driver<br/>(Left)"]
        ENC_R["Encoder Driver<br/>(Right)"]
    end
    subgraph Processing["Processing"]
        FUSION["Sensor Fusion<br/>Node"]
        LOCAL["Localization<br/>Node"]
        PATH["Path<br/>Planner"]
    end
    subgraph Control["Control"]
        DIFF["Differential<br/>Drive Node"]
    end
    subgraph Actuators["Actuators"]
        MOT_L["Motor Driver<br/>(Left)"]
        MOT_R["Motor Driver<br/>(Right)"]
    end
    IMU --> FUSION
    ENC_L --> FUSION
    ENC_R --> FUSION
    ...
    DIFF --> MOT_R
`}
  caption="Differential drive robot architecture"
/>
...
flowchart LR
    IMU["IMU<br/>Driver"]
    GPS["GPS<br/>Driver"]
    ENC["Encoders<br/>Driver"]
    FUSION["Sensor Fusion<br/>(EKF/UKF)"]
    OUTPUT["Output<br/>Pose"]
    IMU --> FUSION
    GPS --> FUSION
    ENC --> FUSION
    FUSION --> OUTPUT
...
- [Scheduler](/advanced/scheduler-configuration) - Node scheduling
