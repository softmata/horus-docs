...
> **Under Development**: Sim2D is currently under active development. Core simulation features (physics, sensors, HORUS integration) work, but some functionality is still being refined. Check back for updates as we complete this feature.
...
impl WallFollower {
    fn new() -> Result<Self> {
        Ok(Self {
            cmd_pub: Topic::new("robot.cmd_vel")?,
            scan_sub: Topic::new("robot.scan")?,
        })
    }
}
