...
description: "The 6 execution classes — Rt, Compute, Event, AsyncIo, Gpu, BestEffort — and when to use each"
order: 22
...
HORUS solves this with **execution classes**: six different executors, each optimized for a specific workload type. The scheduler automatically selects the right class based on how you configure the node — you describe what your node needs, and the scheduler figures out how to run it.
...
flowchart TD
    ...
    A -->|".gpu()"| G["Gpu<br/>CUDA stream per node"]
