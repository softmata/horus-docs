...
**Sub-Microsecond Communication**: Achieve ~85ns-167ns latency for robotics messages, enabling real-time control loops at 1kHz+ frequencies
...
- **Performance**: Per-project `.horus` build directories isolate dependencies between robot types
