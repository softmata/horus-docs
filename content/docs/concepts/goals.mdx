...
**Unified High-Level Workflow**: Single command for build, run, and deployment across Rust and Python with minimal configuration (simple horus.toml vs complex ROS XML)
...
scheduler.add(CartographerNode::new()?).order(2).build();
```
