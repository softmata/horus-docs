...
| Message | Description |
|---------|-------------|
| `RobotState` | Robot state for fleet coordination |
| `FleetStatus` | Fleet-wide status |
| `TaskAssignment` | Task allocation |
| `FormationControl` | Formation control parameters |
| `AuctionBid` | Task auction bid |
