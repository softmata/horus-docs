...
// simplified
  ...
  <LangTab language="Python">
    ...
    scheduler = horus.Scheduler(
        ...
        blackbox_mb=64,            # 64 MB flight recorder
        max_deadline_misses=50,    # Emergency stop after 50 misses
...
// simplified
  ...
  <LangTab language="Python">
    ...
    # Async I/O — network, HTTP, database (auto-detected from `async def upload_tick`)
    cloud_uploader = horus.Node("CloudUploader", tick=upload_tick)
    ```
  </LangTab>
</LanguageTabs>
