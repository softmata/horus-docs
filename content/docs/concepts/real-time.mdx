...
│  Timing: 1-10 Hz, best-effort              │
├─────────────────────────────────────────────┤
│  Horus (soft RT, Linux userspace)           │
│  Perception, control loops, sensor fusion   │
│  Timing: 50-1000 Hz, ms-level deadlines     │
├─────────────────────────────────────────────┤
│  Firmware / RTOS (hard RT)                  │
│  PWM generation, current loops, IMU sampling│
│  Timing: 1-50 kHz, μs-level deadlines       │
├─────────────────────────────────────────────┤
│  Hardware                                   │
│  Motors, sensors, encoders, batteries       │
└─────────────────────────────────────────────┘
```
