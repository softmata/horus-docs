...
flowchart TB
    ...
    SCHED --> PAR["<b>Default</b><br/>Ready dispatch, multi-core"]
    SCHED --> SEQ["<b>deterministic(true)</b><br/>Sequential, same order every run"]
`}
  caption="Default Parallel Dispatch vs. Deterministic Mode"
/>
