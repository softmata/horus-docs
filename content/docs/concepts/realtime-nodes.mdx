...
// Enable safety features via SchedulerConfig:
// - WCET enforcement
// - Deadline monitoring
// - Watchdog timers (100ms timeout)
// - Emergency stop on violations
// Use RtConfig for system-level RT (memory locking, SCHED_FIFO)
...
// - 10kHz control loops
// Use RtConfig for system-level RT (CPU affinity, memory locking)
