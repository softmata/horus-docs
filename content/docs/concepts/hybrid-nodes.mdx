...
**For most users: Not at first.** Hybrid nodes are an advanced pattern for customizing built-in nodes.

**When this page IS useful:**
- Want to add processing (like edge detection) to a camera node
- Need to filter or transform data from prebuilt sensor nodes
- Building pipelines that chain multiple transformations

**Quick answer:** Start with regular nodes. Come back to hybrid nodes when you want to inject custom processing into existing nodes.
...
```rust
use horus::prelude::*; // Provides CameraNode
...
```rust
use horus::prelude::*; // Provides {CameraNode, Image}
...
```rust
use horus::prelude::*; // Provides Processor
...
```rust
use horus::prelude::*; // Provides {CameraNode, CameraConfig}
...
```rust
use horus::prelude::*; // Provides {processor, filter}
...
```rust
use horus::prelude::*; // Provides PassThrough
...
```rust
use horus::prelude::*; // Provides ClosureProcessor
...
```rust
use horus::prelude::*; // Provides FilterProcessor
...
```rust
use horus::prelude::*; // Provides Pipeline
...
```rust
use horus::prelude::*; // Provides Tap
...
```rust
use horus::prelude::*; // Provides {processor, ProcessorExt}
...
```rust
use horus::prelude::*; // Provides {processor, filter, tap}
...
```rust
use horus::prelude::*; // Provides {Scheduler, CameraNode, CameraConfig, processor, filter, tap}
...
- [Basic Examples](/rust/examples/basic-examples) - Working example code
