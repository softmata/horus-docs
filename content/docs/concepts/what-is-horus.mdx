...
| Metric | Value |
|--------|-------|
| Minimum latency | ~85 ns |
| Median latency | ~167 ns |
| p99 latency | ~450 ns |
...
| Aspect | HORUS | ROS |
|--------|-------|-----|
| Typical latency | ~0.085-0.167 µs | 50-100 µs (intra-machine DDS) |
...
|--------|-------|----------------|
| Latency | ~0.085-0.167 µs | 1-10 ms |
