...
Transform frames live in their own crate — the `horus` umbrella crate does not pull it in, so add it to your `Cargo.toml`:
...
// Roll/pitch/yaw convenience constructor
