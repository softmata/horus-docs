...
| **Service** | Request/response RPC | Parameter queries, configuration, one-shot commands |
...
- [Topic Details](/concepts/core-concepts-topic) - Architecture and design patterns
- [Topic API Reference](/rust/api/topic) - Full method documentation
- [Actions](/concepts/actions) - Goal/feedback/result pattern
- [Services](/concepts/services) - Synchronous request/response RPC
