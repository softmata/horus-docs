...
flowchart TB
    ...
    subgraph COMM["Communication Layer"]
        TOPIC["Topic&lt;T&gt;<br/>(auto-detects backend)"]
    end
...
let pub1: Topic<Imu> = Topic::new("sensors.imu")?;
let pub2: Topic<Imu> = Topic::new("sensors.imu")?;

// Multiple subscribers receive all messages
let sub1: Topic<Imu> = Topic::new("sensors.imu")?;
let sub2: Topic<Imu> = Topic::new("sensors.imu")?;
```
