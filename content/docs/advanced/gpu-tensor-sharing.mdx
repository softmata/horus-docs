...
**For most users: No.** This is only needed for GPU-heavy ML pipelines.

**When this page IS useful:**
- Running ML models (YOLO, neural networks) on GPU
- Need to share GPU data between multiple processes without CPU copies
- Building high-performance perception-to-action pipelines

**Quick answer:** If you're not using NVIDIA GPUs for ML inference, skip this entirely. If you are, this can give you significant speedups (4ms+ per frame saved).
...
let msg: IpcHandleMsg = topic.recv()?;
