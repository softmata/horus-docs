...
# horus record replay <session_name> --speed 0.5 --start-tick 100
```

> **Note**: Programmatic replay (`replay_from()`, `add_replay()`, time travel, mixed replay, output overrides) is currently Rust-only. Python supports recording, stopping, listing, and deleting recordings. Use the CLI for replay operations from Python projects.
