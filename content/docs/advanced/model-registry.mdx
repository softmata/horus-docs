...
**For most users: Not initially.** Model registry helps manage multiple ML model versions.

**When this page IS useful:**
- Using ML models (YOLO, neural networks, etc.) in your robot
- Need to track different model versions (A/B testing, rollback)
- Team collaborating on model development

**Quick answer:** If you're not using ML models yet, skip this. If you have one model that works, skip this. Use it when model management becomes a headache.
...
- [Tensor Messages](/rust/api/tensor-messages) - Tensor data types
