...
diagnostics.status     Generic     shm           2     2     ~167ns
```
...
| Many publishers &rarr; many subscribers | ~167ns |
...
- **Latency overhead.** DDS adds 50-200us of latency even for same-machine communication. HORUS achieves 3-167ns.
