...
**For most users: No.** Safety Monitor is for systems where failures have serious consequences.

**When this page IS useful:**
- Building medical devices or industrial robots
- Working with hardware that can hurt people if it malfunctions
- Regulatory compliance (ISO 26262, IEC 62443)
- Need emergency stop functionality

**Quick answer:** If your robot can't hurt anyone or damage property, skip this. Use it when safety is non-negotiable.
...
stateDiagram-v2
    ...
    Degraded --> SafeMode : significant issues
    Degraded --> EmergencyStop : critical failure
    SafeMode --> EmergencyStop : critical failure
`}
...
// Or using SchedulerConfig preset
