...
description: "Understanding HORUS scheduler execution modes: Parallel, Sequential, AsyncIO, and AutoAdaptive"
weight: 41
---
...
|------|----------|-------------------|
| **UltraFast** | Simple math, &lt;1μs | Inline execution (highest priority) |
...
scheduler.add(pid).order(0).tier(NodeTier::UltraFast).done();
...
| Feature | Sequential | Parallel | AsyncIO | AutoAdaptive |
|---------|------------|----------|---------|--------------|
| Deterministic | **Yes** | Via profile | Via profile | **No** |
| Multi-core | No | Yes | Partial | Auto |
| Async I/O | No | No | Yes | Auto |
| Learning Phase | No | No | No | **Yes** |
| Best Latency | 87-313ns | Variable | Variable | Variable |
| Certification Ready | **Yes** | No | No | No |
...
flowchart TB
    ...
    UFAST["NodeTier::UltraFast<br/>(high-freq)"]
