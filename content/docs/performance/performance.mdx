...
**Headlines:** 87ns send latency (SPSC), 230-575x faster than ROS2 DDS, 12M+ msg/sec throughput for small messages.

### Throughput

HORUS can handle:
- **12M+ messages/second** for small messages (16B) with SPSC Topic
- **3M+ messages/second** for small messages (16B) with MPMC Topic
