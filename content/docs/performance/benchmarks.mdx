...
|-----------|---------|------------|----------|
| Same-thread | ~23 ns | 40M+ msg/s | In-process pipeline |
| Cross-thread 1:1 | ~155 ns | 10M+ msg/s | Multi-threaded nodes |
| Cross-process 1:1 | ~180 ns | 5M+ msg/s | Multi-process systems |
| CmdVel (motor control) | ~500 ns | 2.7M msg/s | 1000 Hz control loops |
| IMU (sensor fusion) | ~940 ns | 1.8M msg/s | 100 Hz sensor data |
| LaserScan (2D lidar) | ~2.2 us | 633K msg/s | 10 Hz perception |
| PointCloud 10K pts | ~360 us | 4.7K msg/s | 30 Hz 3D perception |
| Python typed msg | ~1.5 us | N/A | AI/ML nodes |
...
- [Optimization Guide](/performance/performance) — When and how to optimize
- [Scheduler API](/rust/api/scheduler) — Timing configuration
