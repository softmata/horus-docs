...
- **Fault injection**: Fault tolerance recovery testing
...
- **Fault Tolerance**: Fault tolerance pattern with automatic recovery
...
| **FaultTolerance** | **25.485s** | With simulated failures | Fault tolerance recovery working |
