...
- [Advanced Examples](/docs/cpp/examples/advanced) — multi-process, cross-language, RT
- [Quick Start](/docs/getting-started/quick-start-cpp) — step-by-step first project
