...
Field offsets are now asserted at compile time by
`horus/layout_contract.hpp` — a future divergence between the C++ headers and
Rust is a build failure rather than a silent misread of shared memory.
</Callout>
