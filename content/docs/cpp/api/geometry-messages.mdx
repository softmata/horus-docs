...
- [Sensor Messages](/docs/cpp/api/sensor-messages) — Odometry uses Pose2D + Twist
- [TransformFrame API](/docs/cpp/api/transform) — uses TransformStamped internally
- [Navigation Messages](/docs/cpp/api/navigation-messages) — NavGoal uses Pose2D
