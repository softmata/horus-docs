...
- [Recipe: PID Controller](/recipes/pid-controller-cpp) — using PidConfig in practice
- [Recipe: Differential Drive](/recipes/differential-drive-cpp) — CmdVel to wheel speeds
