...
horus plugins available --local

# Show detailed info about a specific plugin
horus plugins info horus-rplidar
```
...
The `horus add` command provides smart auto-detection. It recognizes plugins automatically:
